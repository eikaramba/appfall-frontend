<script>
	...
	let eventText="Für Erinnerungen ein Datum anklicken";
	...
	function initMonthItems() {
		...
		let m = month;
		items=[
			{title:"Wertstofftonne",date:new Date(y,m,randInt(7)+14),className:"task--info",len:1},
			{title:"Bio",date:new Date(y,m,randInt(7)+14),className:"task--green",len:1},
			{title:"Restmüll",date:new Date(y,m,randInt(7)+21),className:"task--danger",len:1,vlen:2},
		];
